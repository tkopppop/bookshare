...
[부가적 사항]
* 활동한 해커 팀: (1) 와우 해커 커뮤니티(오버헤드 4기 소수 정예 가족) ->
               (2) isec.pl 폴란드 연구소(*)(저작권은 제게 있고 활용 가능하도록 제 아이디를 넘겨 줬습니다)리눅스 커널 취약점 제로데이 연구원 리더 ->
               (3) 사업체프랙 해커팀 TCLH(The Circle of Lost Hackers) 리더 ->
               (4) (주)아이넷캅 코드 연구팀 취약점 연구원!
